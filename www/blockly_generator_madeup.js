...
Blockly.Madeup['madeup_generate_echo'] = function(block) {
  var value_message = Blockly.Madeup.valueToCode(block, 'MESH', Blockly.Madeup.ORDER_FUNCTION_CALL_ONLY_PARAMETER);
