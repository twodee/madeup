...
Blockly.Madeup['madeup_io_print'] = function(block) {
  var value_message = Blockly.Madeup.valueToCode(block, 'MESSAGE', Blockly.Madeup.ORDER_ATOMIC);
...
Blockly.Madeup['madeup_movement_moveto'] = function(block) {
  var value_x = Blockly.Madeup.valueToCode(block, 'X', Blockly.Madeup.ORDER_ATOMIC);
  var value_y = Blockly.Madeup.valueToCode(block, 'Y', Blockly.Madeup.ORDER_ATOMIC);
  var value_z = Blockly.Madeup.valueToCode(block, 'Z', Blockly.Madeup.ORDER_ATOMIC);
  var code = 'moveto ' + value_x + ', ' + value_y + ', ' + value_z + '\n';
  return code;
};

Blockly.Madeup['madeup_movement_move'] = function(block) {
  var value_distance = Blockly.Madeup.valueToCode(block, 'DISTANCE', Blockly.Madeup.ORDER_ATOMIC);
...
Blockly.Madeup['madeup_loop_repeat'] = function(block) {
  var value_count = Blockly.Madeup.valueToCode(block, 'COUNT', Blockly.Madeup.ORDER_ATOMIC);
...
Blockly.Madeup['madeup_math_inverse_sincostan'] = function(block) {
  var value_ratio = Blockly.Madeup.valueToCode(block, 'RATIO', Blockly.Madeup.ORDER_ATOMIC);
  var dropdown_f = block.getFieldValue('F');
...
Blockly.Madeup['madeup_generate_ball'] = function(block) {
  var code = 'ball\n';
  return code;
};
...
Blockly.Madeup['madeup_generate_surface'] = function(block) {
  var value_columns = Blockly.Madeup.valueToCode(block, 'COLUMNS', Blockly.Madeup.ORDER_ATOMIC);
  var value_rows = Blockly.Madeup.valueToCode(block, 'ROWS', Blockly.Madeup.ORDER_ATOMIC);
  var code = 'surface ' + value_columns + ', ' + value_rows + '\n';
  return code;
};

Blockly.Madeup['madeup_math_log'] = function(block) {
  var value_base = Blockly.Madeup.valueToCode(block, 'BASE', Blockly.Madeup.ORDER_ATOMIC);
  var value_x = Blockly.Madeup.valueToCode(block, 'X', Blockly.Madeup.ORDER_ATOMIC);
...
Blockly.Madeup['madeup_logic_if_expr'] = function(block) {
  var value_condition = Blockly.Madeup.valueToCode(block, 'CONDITION', Blockly.Madeup.ORDER_ATOMIC);
  var value_then = Blockly.Madeup.valueToCode(block, 'THEN', Blockly.Madeup.ORDER_ATOMIC);
  var value_else = Blockly.Madeup.valueToCode(block, 'ELSE', Blockly.Madeup.ORDER_ATOMIC);
...
Blockly.Madeup['madeup_loop_for_to'] = function(block) {
  var value_stop = Blockly.Madeup.valueToCode(block, 'STOP', Blockly.Madeup.ORDER_ATOMIC);
...
Blockly.Madeup['madeup_loop_for_in'] = function(block) {
  var value_start = Blockly.Madeup.valueToCode(block, 'START', Blockly.Madeup.ORDER_ATOMIC);
  var variable_iterator = Blockly.Madeup.variableDB_.getName(block.getFieldValue('ITERATOR'), Blockly.Variables.NAME_TYPE);
  var value_stop = Blockly.Madeup.valueToCode(block, 'STOP', Blockly.Madeup.ORDER_ATOMIC);
  var statements_body = Blockly.Madeup.statementToCode(block, 'BODY');
