  ...
  public:
    ...
    Co<Expression> Evaluate(Environment& env) {
      ...
      if (a_closure.IsNull() || b_closure.IsNull()) {
        throw MessagedException(GetSourceLocation() + ": I expect function max to be given two numbers, a and b. You didn't give max two numbers.");
      }
      ...
      if (a_integer && b_integer) {
        ...
        if (!a_number) {
          throw MessagedException(a_closure->GetSourceLocation() + ": I expect function max to be given a number. That thing you gave it wasn't a number.");
        } else if (!b_number) {
          throw MessagedException(b_closure->GetSourceLocation() + ": I expect function max to be given a number. That thing you gave it wasn't a number.");
        } else {
