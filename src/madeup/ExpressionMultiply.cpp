...
Co<Expression> ExpressionMultiply::evaluate_helper(Co<Expression> l,
                                                   Co<Expression> r,
  ...
  throw MessagedException(location.toAnchor() + ": Operator * doesn't know how to multiply " + l->getSource() + " and " + r->getSource() + ".");
}
