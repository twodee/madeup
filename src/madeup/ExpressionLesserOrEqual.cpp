...
ExpressionLesserOrEqual::ExpressionLesserOrEqual(Co<Expression> left, Co<Expression> right) :
  Expression(),
  left(left),
  right(right) {
}
...
Co<Expression> ExpressionLesserOrEqual::evaluate(Environment &env) const {
  return evaluate_helper(left, right, getSource(), getSourceLocation(), env);
}

/* ------------------------------------------------------------------------- */

Co<Expression> ExpressionLesserOrEqual::evaluate_helper(Co<Expression> l,
                                                        Co<Expression> r,
...
void ExpressionLesserOrEqual::write(ostream &out) const {
  out << "(<= ";
  left->write(out);
  out << " ";
  right->write(out);
